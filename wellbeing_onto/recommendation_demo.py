...
SCALE_TO_ONTOLOGY_TARGET = {
    ("DASS-21", "Stress"): "Воспринимаемый стресс",
    ("DASS-21", "Anxiety"): "Тревожность",
    ("DASS-21", "Depression"): "Депрессивная симптоматика",

    ("STAI", "State"): "Ситуативная",
    ("STAI", "Trait"): "Личностная",

    ("Шкала депрессии Бека", "Cognitive-Affective"): "Когнитивно-аффективные проявления",
    ("Шкала депрессии Бека", "Somatic"): "Соматические проявления",
    ("Шкала депрессии Бека", "Depression"): "Депрессивная симптоматика",

    ("BAT", "Exhaustion"): "Истощение",
    ("BAT", "Distancing"): "Дистанцирование",
    ("BAT", "Cognitive Impairment"): "Когнитивные затруднения",
    ("BAT", "Emotional Impairment"): "Эмоциональные затруднения",
    ("BAT", "Secondary Symptoms"): "Вторичные симптомы",

    ("Шкала проф. апатии", "Apathetic Thoughts"): "Апатичные мысли",
    ("Шкала проф. апатии", "Apathetic Actions"): "Апатичные действия",

    ("CMQ", "Cognitive Distortions"): "Когнитивные искажения",

    ("PSS", "Stress"): "Воспринимаемый стресс",
    ("PSS", "Distress"): "Дистресс",
    ("PSS", "Coping"): "Совладание",

    ("5PFQ", "Extraversion"): "Экстраверсия",
    ("5PFQ", "Self-Regulation"): "Саморегуляция",
    ("5PFQ", "Attachment"): "Привязанность",
    ("5PFQ", "Neuroticism"): "Нейротизм",
    ("5PFQ", "Openness"): "Открытость опыту",

    ("Нечеткая модель", "Burnout Proneness"): "Склонность к выгоранию",

    ("Индикатор копинг-стратегий", "Coping"): "Копинги",

    ("Шкала эмоциональных схем", "Emotional Schemas"): "Эмоциональные схемы",

    ("Tracker", "Mood"): "Настроение",
}
